...
setwd("C:/Users/Madhavi/Desktop/Coursera/Reproducible Research")

if(!file.exists("repdata_data_StormData.csv"))
  fileUrl <- "https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2"
download.file(fileUrl,destfile="StormData.csv")
unzip2(temp, "repdata_data_StormData.csv")
...
##From the aove histogram, it is evident that the number of events tracked starts to significantly increase around 1995. So, we use the subset of the data from 1990 to 2011 to get most out of good records.

storm <- stormData[stormData$year >= 1995, ]
dim(storm)

##Impact on Public Health
###Here, we check the number of fatalities and injuries that are caused by the severe weather events. We would like to get the first 15 most severe types of weather events.
...
##Impact on Economy
###We will convert the property damage and crop damage data into comparable numerical forms according to the meaning of units described in the code book (Storm Events). Both  PROPDMGEXP  and  CROPDMGEXP  columns record a multiplier for each observation where we have Hundred (H), Thousand (K),Million (M) and Billion 
...
## Graph the injuries and fatalities
...
###Based on the above histograms, we find that excessive heat and tornado cause most fatalities; causes most injuries in the United States from 1995 to 2011.As for the impact on economy, we have got two sorted lists below by the amount of money cost by damages. 
